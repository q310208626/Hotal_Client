...
public class OrderQueryHttp {
    ...
    public JSONArray doPost(java.lang.String url, Map<java.lang.String,java.lang.String> map, java.lang.String charset) {
        ...
        try {
            ...
            if (httpResponse.getStatusLine().getStatusCode()== 200){
                ...
                if (httpEntity!=null){
                    try {
                        orderQueryJsonArray=new JSONArray(EntityUtils.toString(httpEntity).trim());
                        System.out.print(orderQueryJsonArray+"\n");
            ...
            try {
                orderQueryJsonArray.put("connectError");
            } catch (Exception e1) {
                e1.printStackTrace();
            }
            e.printStackTrace();
        }
        return orderQueryJsonArray;
    }
