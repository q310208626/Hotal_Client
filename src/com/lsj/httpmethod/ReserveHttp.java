...
/**
 * Created by hdmi on 16-12-3.
 */
public class ReserveHttp {
    public JSONObject doPost(java.lang.String url, Map<java.lang.String,java.lang.String> map, java.lang.String charset) {
        ...
        try {
            ...
            if (httpResponse.getStatusLine().getStatusCode()== 200){
                ...
                if(httpEntity!=null){
                    try {
                        resultObjectJson=new JSONObject(EntityUtils.toString(httpEntity).trim());
                ...
                try {
                    resultObjectJson.put("result","connectError");
                } catch (JSONException e) {
                    e.printStackTrace();
                }
